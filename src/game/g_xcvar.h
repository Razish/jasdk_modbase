...
XCVAR_DEF( g_allowNPC,					"1",			NULL,				CVAR_SERVERINFO|CVAR_CHEAT,						qtrue )
...
XCVAR_DEF( g_forceRegenTime,			"200",			NULL,				CVAR_SERVERINFO|CVAR_ARCHIVE,					qtrue )
...
XCVAR_DEF( g_gametype,					"0",			G_ValidateGametype,	CVAR_SERVERINFO|CVAR_LATCH,						qfalse )
...
XCVAR_DEF( g_listEntity,				"0",			NULL,				CVAR_NONE,										qfalse )
...
XCVAR_DEF( g_maxForceRank,				"6",			NULL,				CVAR_SERVERINFO|CVAR_ARCHIVE|CVAR_LATCH,		qfalse )
...
XCVAR_DEF( g_password,					"",				NULL,				CVAR_USERINFO,									qfalse )
...
XCVAR_DEF( g_saberLocking,				"1",			NULL,				CVAR_SERVERINFO|CVAR_ARCHIVE,					qtrue )
...
XCVAR_DEF( g_saberWallDamageScale,		"0.4",			NULL,				CVAR_SERVERINFO,								qfalse )
...
XCVAR_DEF( sv_mapname,					"",				NULL,				CVAR_SERVERINFO|CVAR_ROM,						qfalse )
...
XCVAR_DEF( ui_singlePlayerActive,		"",				NULL,				CVAR_NONE,										qfalse )
